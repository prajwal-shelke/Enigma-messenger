...
<body>
  <div class="wrapper">
    <section class="users">
      <header>
        ...
        <a href="https://enigma-messenger.herokuapp.com/php/logout.php?logout_id=<?php echo $row['unique_id']; ?>" class="logout">Logout</a>
      </header>
      <div class="search">
  ...
  <script src="https://enigma-messenger.herokuapp.com/javascript/users.js"></script>
